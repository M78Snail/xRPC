...
public class ServiceWrapper {
	...
	public ServiceWrapper(Object serviceProvider, Object mockDegradeServiceProvider, String serviceName,
			String responsiblityName, String methodName, List<Class<?>[]> paramters, boolean isSupportDegradeService,
			String degradeServicePath, String degradeServiceDesc, int weight, int connCount, boolean isVIPService,
			boolean isFlowController, long maxCallCountInMinute) {
	...
	public String toString() {
		return "ServiceWrapper [serviceProvider=" + serviceProvider + ", mockDegradeServiceProvider="
				+ mockDegradeServiceProvider + ", serviceName=" + serviceName + ", responsiblityName="
				+ responsiblityName + ", methodName=" + methodName + ", paramters=" + paramters
				+ ", isSupportDegradeService=" + isSupportDegradeService + ", degradeServicePath=" + degradeServicePath
				+ ", degradeServiceDesc=" + degradeServiceDesc + ", isVIPService=" + isVIPService + ", weight=" + weight
				+ ", connCount=" + connCount + ", isFlowController=" + isFlowController + ", maxCallCountInMinute="

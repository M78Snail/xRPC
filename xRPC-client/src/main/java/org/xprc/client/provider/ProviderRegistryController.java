...
public class ProviderRegistryController {
	...
	public ProviderRegistryController(DefaultProvider defaultProvider) {
		...
		// providerMonitorController = new
		// ProviderMonitorController(defaultProvider);
	}
	...
	// }
	//
	// public void setProviderMonitorController(ProviderMonitorController
	// providerMonitorController) {

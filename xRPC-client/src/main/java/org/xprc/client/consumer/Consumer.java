...
public interface Consumer {
	 ...
	 * @return
	 */
	ChannelGroup loadBalance(String serviceName, LoadBalanceStrategy directBalanceStrategy);
	 ...
	 */
	RemotingTransporter sendRpcRequestToProvider(Channel channel, RemotingTransporter request, long timeout)

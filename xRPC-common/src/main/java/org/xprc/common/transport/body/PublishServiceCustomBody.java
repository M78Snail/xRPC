...
public class PublishServiceCustomBody implements CommonCustomBody {
	...
	public String toString() {
		return "PublishServiceCustomBody [host=" + host + ", port=" + port + ", serviceProviderName="
				+ serviceProviderName + ", isVIPService=" + isVIPService + ", isSupportDegradeService="
				+ isSupportDegradeService + ", degradeServicePath=" + degradeServicePath + ", degradeServiceDesc="
				+ degradeServiceDesc + ", weight=" + weight + ", connCount=" + connCount + ", maxCallCountInMinute="
				+ maxCallCountInMinute + ", isFlowController=" + isFlowController + "]";
	}
}
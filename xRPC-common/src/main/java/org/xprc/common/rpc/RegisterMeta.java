...
public class RegisterMeta {
	...
	public RegisterMeta(Address address, String serviceName, boolean isVIPService, boolean isSupportDegradeService,
			String degradeServicePath, String degradeServiceDesc, int weight, int connCount) {
	...
	@Override
	public String toString() {
		return "RegisterMeta [address=" + address + ", serviceName=" + serviceName + ", isVIPService=" + isVIPService
				+ ", isSupportDegradeService=" + isSupportDegradeService + ", degradeServicePath=" + degradeServicePath
				+ ", degradeServiceDesc=" + degradeServiceDesc + ", weight=" + weight + ", connCount=" + connCount
				+ ", isReviewed=" + isReviewed + ", hasDegradeService=" + hasDegradeService + "]";
	}
	...
	public static RegisterMeta createRegiserMeta(PublishServiceCustomBody publishServiceCustomBody, Channel channel) {
		...
		RegisterMeta registerMeta = new RegisterMeta(address, publishServiceCustomBody.getServiceProviderName(),
				publishServiceCustomBody.isVIPService(), publishServiceCustomBody.isSupportDegradeService(),
				publishServiceCustomBody.getDegradeServicePath(), publishServiceCustomBody.getDegradeServiceDesc(),
				publishServiceCustomBody.getWeight(), publishServiceCustomBody.getConnCount());
		return registerMeta;
	}
}
